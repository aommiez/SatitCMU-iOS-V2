...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.showcase = [[PFShowcaseViewController alloc] init];
    self.activity = [[PFActivityViewController alloc] init];
    ...
    if (IS_WIDESCREEN) {
        ...
        self.showcase = [[PFShowcaseViewController alloc] initWithNibName:@"PFShowcaseViewController_Wide" bundle:nil];
        self.activity = [[PFActivityViewController alloc] initWithNibName:@"PFActivityViewController_Wide" bundle:nil];
        ...
        self.showcase = [[PFShowcaseViewController alloc] initWithNibName:@"PFShowcaseViewController" bundle:nil];
        self.activity = [[PFActivityViewController alloc] initWithNibName:@"PFActivityViewController" bundle:nil];
